          ...
          {modalChange === false ? (
            <>
              ...
              >
                ...
                <br />
                Kliknutím na tlačítko vygenerujte stanici a v ní můžete
                uživatelům přiřadit práva pro zobrazení.
              </Typography>
            ...
            <>
              ...
              <Typography id="modal-modal-title" variant="h6" component="h2">
               Než okno zavřete zapiště si vytvořené údaje!<br/>
               Z bezpečnostních důvodů udaje nikde neukládáme.
              </Typography>
              <Typography
                id="modal-modal-description"
                sx={{ mt: 2 }}
